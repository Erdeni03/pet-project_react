...
//     payload: string;
// }
export type ToolAction = SetToolAction | SetFillColor | SetLineWidth | SetStrokeColor
...
export const paintToolReducer = (state = initialState, action: ToolAction): ToolState => {
